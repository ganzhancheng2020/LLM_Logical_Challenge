...
# nohup python -m vllm.entrypoints.openai.api_server --model ./model/Meta-Llama-3.1-8B-Instruct-lora  --served-model-name Meta-Llama-3.1-8B-Instruct-lora --max-model-len=4096 &
